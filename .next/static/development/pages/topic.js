((window["webpackJsonp"] = window["webpackJsonp"] || []).push([["static\\development\\pages\\topic.js"],{
...
var ListItem = function ListItem(props) {
  ...
  var renderList = function renderList(topic) {
    return topicState.map(function (item, key) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        key: key
      }, "".concat(item.title, " - ").concat(item.content, " - ").concat(item.name));
    });
  };

  var addListTopic = function addListTopic() {
    var data = {
      title: '1111',
      content: '22222',
      name: '33333'
    };
    settopicState([].concat(_toConsumableArray(topicState), [data]));
  };
...
/***/ 3:
/*!******************************!*\
  !*** multi ./pages/topic.js ***!
  \******************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__NEXT_REGISTER_PAGE('/topic', function() {
module.exports = __webpack_require__(/*! ./pages/topic.js */"./pages/topic.js");
